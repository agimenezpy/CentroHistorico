...
Listado::Listado(QWidget *parent) :
    ...
    model->select();
    model->setHeaderData(1, Qt::Horizontal, QString::fromUtf8("Número"));
    model->setHeaderData(0, Qt::Horizontal, "Cuenta Corriente");
    model->setHeaderData(7, Qt::Horizontal, QString::fromUtf8("Denominación"));
    model->setHeaderData(2, Qt::Horizontal, QString::fromUtf8("Dirección"));
